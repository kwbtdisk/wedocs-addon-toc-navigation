...
if ( ! class_exists( 'WeDocs_Toc_Nav_Walker_Docs' ) ) :

  /**
   * weDocs Docs Walker
   */
  class WeDocs_Toc_Nav_Walker_Docs extends Walker_Page {
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
      ...
      $indexedToc = toc_get_index($page->post_content, get_permalink( $page ), true);
      if ($indexedToc) {
        $output .= '<ul class="children">' . $indexedToc .'</ul>';
      }
    }
  }
